...
{
    public class SeleniumWithContext :IClassFixture<SeleniumWebDriverFixture>
    {
        ...
        private readonly SeleniumWebDriverFixture _driverFixture;

        public SeleniumWithContext(SeleniumWebDriverFixture fixture)
        {
